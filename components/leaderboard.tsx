    ...
    >
      ...
      >
        <thead>
          ...
          >
            <th style={{ padding: 0, borderTopLeftRadius: 8, width: rankColWidth, fontWeight: 900, fontSize: 11 }}>#</th>
            <th style={{ padding: 0, width: logoColWidth, fontWeight: 900, fontSize: 11 }}> </th>
            <th style={{ padding: 0, width: teamNameColWidth, fontWeight: 900, fontSize: 11 }}>TEAM NAME</th>
            <th style={{ padding: 0, width: statusColWidth, fontWeight: 900, fontSize: 11, borderRight: '1px solid #bdbdbd', borderLeft: '1px solid #bdbdbd' }}>STATUS</th>
            <th style={{ padding: 0, borderTopRightRadius: 8, width: elimsColWidth, fontWeight: 900, fontSize: 11 }}>ELIMS</th>
          </tr>
        </thead>
        <tbody>
